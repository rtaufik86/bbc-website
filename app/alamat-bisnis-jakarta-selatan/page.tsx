...
export default function Page() {
    ...
    return (
        <main className="bg-white text-slate-900 font-sans selection:bg-bbc-gold-500 selection:text-white">
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div>
                            <div className="flex items-center gap-2 mb-8">
                                ...
                                <span className="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest border border-blue-200">
                                    Jakarta Selatan
                                </span>
                            </div>
                            <h1 className="text-4xl lg:text-6xl font-bold text-[#1E3A8A] leading-tight mb-8 font-playfair">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <Button className="bg-[#F59E0B] hover:bg-[#D97706] text-white rounded-none px-8 py-6 text-sm font-bold uppercase tracking-widest transition-all shadow-lg" asChild>
                                    <Link href="/virtual-office">Dapatkan Alamat Bisnis Sah</Link>
                                </Button>
                            </div>
                        </div>
                        <div className="relative h-[400px] lg:h-[500px] hidden lg:block rounded-2xl overflow-hidden shadow-2xl border-b-8 border-[#F59E0B]">
                            <Image
                                src="/images/hero-alamat-bisnis-jakarta-selatan.jpg"
                                alt="Alamat Bisnis Jakarta Selatan - Bintaro Business Centre"
                                fill
            ...
            <section className="py-24 bg-white border-b border-slate-100">
                <div className="container mx-auto px-6 max-w-4xl text-center">
                    <h2 className="text-3xl font-bold text-[#1E3A8A] mb-8 font-playfair italic">Kenapa Alamat Bisnis Begitu Menentukan?</h2>
                    <div className="space-y-6 text-slate-600 leading-relaxed text-lg text-left">
                        <p>
                            Banyak pengusaha pemula meremehkan pemilihan domisili. Namun, fakta hukum di Indonesia menunjukkan bahwa validitas alamat adalah syarat mutlak untuk mendapatkan legalitas sah seperti <span className="text-bbc-gold-600 font-bold">NIB, NPWP, hingga Sertifikat PKP</span>.
                        </p>
                        <p>
            ...
            <section className="py-24 bg-slate-50">
                <div className="container mx-auto px-6 max-w-7xl">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl lg:text-4xl font-bold text-[#1E3A8A] mb-4 font-playfair">Manfaat Strategis Domisili Jakarta Selatan</h2>
                    ...
                    <div className="grid md:grid-cols-3 gap-12">
                        {[
                            ...
                            <div key={i} className="bg-white p-10 shadow-sm border-l-4 border-[#1E3A8A] hover:shadow-xl transition-all group">
                                <item.icon className="w-12 h-12 text-[#F59E0B] mb-8 group-hover:scale-110 transition-transform" />
            ...
            <section className="py-24 bg-white">
                <div className="container mx-auto px-6 max-w-5xl">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-[#1E3A8A] mb-4 font-playfair">Mengenal Opsi Alamat Bisnis Sah</h2>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="border border-slate-200 p-10 rounded-xl hover:border-[#1E3A8A] transition-all bg-white shadow-sm">
                            <h3 className="text-2xl font-bold text-[#1E3A8A] mb-4">Virtual Office</h3>
                            ...
                            <Link href="/virtual-office-jakarta-selatan" className="text-[#1E3A8A] font-bold text-xs uppercase tracking-widest hover:underline flex items-center gap-2"> Pelajari Detail VO <ExternalLink size={14} /></Link>
                        </div>
                        <div className="border border-slate-200 p-10 rounded-xl hover:border-[#1E3A8A] transition-all bg-white shadow-sm">
                            <h3 className="text-2xl font-bold text-[#1E3A8A] mb-4">Service Office</h3>
                            ...
                            <Link href="/sewa-kantor" className="text-[#1E3A8A] font-bold text-xs uppercase tracking-widest hover:underline flex items-center gap-2"> Lihat Ruang Kantor <ExternalLink size={14} /></Link>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 bg-[#1E3A8A] text-white overflow-hidden relative">
                ...
                <div className="container mx-auto px-6 max-w-7xl relative z-10">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div>
                            <h2 className="text-3xl lg:text-4xl font-bold mb-8 font-playfair">Mengapa Bermitra dengan <br/><span className="text-[#F59E0B]">Bintaro Business Centre?</span></h2>
                            ...
                            <div className="grid grid-cols-2 gap-8">
                                <div className="flex gap-4 items-start">
                                    <History className="text-[#F59E0B]" size={28} />
                                    <div>
                                ...
                                <div className="flex gap-4 items-start">
                                    <Building2 className="text-[#F59E0B]" size={28} />
                                    <div>
                                ...
                                <div className="flex gap-4 items-start">
                                    <Award className="text-[#F59E0B]" size={28} />
                                    <div>
                        ...
                        <div className="relative h-[300px] border-4 border-white/10 rounded-2xl overflow-hidden shadow-2xl">
                            <Image 
                                src="/images/hero-service-kantor.jpg" 
            ...
            <section className="py-24 bg-slate-50">
                <div className="container mx-auto px-6 max-w-7xl">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-[#1E3A8A] mb-4 font-playfair italic">Layanan Terkait untuk Pertumbuhan Bisnis</h2>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            ...
                            <Link key={i} href={link.href} className="bg-white p-8 group border border-slate-100 hover:border-[#F59E0B] transition-all shadow-sm">
                                <h4 className="font-bold text-[#1E3A8A] mb-3 group-hover:text-[#F59E0B] transition-colors">{link.title}</h4>
                                <p className="text-slate-500 text-xs leading-relaxed mb-6 italic">{link.desc}</p>
                                <span className="text-[10px] uppercase tracking-widest font-black text-slate-400 group-hover:text-[#1E3A8A] transition-colors flex items-center gap-2">
            ...
            <section className="py-24 bg-white">
                <div className="container mx-auto px-6 max-w-4xl">
                    <h2 className="text-3xl font-bold text-[#1E3A8A] mb-12 font-playfair text-center">FAQ: Alamat Bisnis Jakarta Selatan</h2>
                        ...
                        {[
                            ...
                            <div key={i} className="border-b border-slate-100 last:border-0">
                                <details className="group">
                                    <summary className="flex justify-between items-center cursor-pointer py-6 font-bold text-[#1E3A8A] hover:text-[#F59E0B] transition-colors list-none">
                                        <span className="text-sm md:text-base leading-relaxed pr-8">{faq.q}</span>
                                        <Plus className="group-open:rotate-45 transition-transform text-[#F59E0B]" size={20} />
                                    </summary>
            ...
            <section className="py-32 bg-slate-50 border-t border-slate-100">
                <div className="container mx-auto px-6 text-center">
                    <h3 className="text-3xl font-bold text-[#1E3A8A] mb-8 font-playfair italic">Mulai Membangun Kredibilitas Anda Hari Ini</h3>
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center">
                        <Button className="bg-[#1E3A8A] hover:bg-[#0F172A] text-white rounded-none px-12 py-7 text-xs font-black uppercase tracking-[0.2em] transition-all shadow-2xl" asChild>
                            <Link href="https://wa.me/628128888069" target="_blank">Konsultasi Via WhatsApp</Link>
                        </Button>
                        <Button variant="outline" className="border-[#1E3A8A] text-[#1E3A8A] hover:bg-[#1E3A8A] hover:text-white rounded-none px-12 py-7 text-xs font-black uppercase tracking-[0.2em] transition-all" asChild>
                    ...
                    <div className="mt-16 flex items-center justify-center gap-6 opacity-30 grayscale">
                        <span className="text-[10px] font-bold uppercase tracking-widest text-[#1E3A8A]">Premium Locations</span>
                        <span className="text-[10px] font-bold uppercase tracking-widest text-[#1E3A8A]">Certified Legal Team</span>
                        <span className="text-[10px] font-bold uppercase tracking-widest text-[#1E3A8A]">Secure Credibility</span>
                    </div>
                </div>
            </section>
        </main>
