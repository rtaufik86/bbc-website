...
export function buildRewriteDraftPrompt(page: RewriteDraftInput): string {
  ...
  lines.push(
    ...
    '',
    '# BBC FACTUAL GUARDRAILS',
    'Lokasi & positioning BBC:',
    '- BBC berlokasi di **Bintaro, Pesanggrahan, Jakarta Selatan**.',
    '- Boleh menyebut keunggulan administratif Jakarta Selatan TANPA mengimplikasikan BBC berada di Sudirman/Kuningan/SCBD/TB Simatupang.',
    '- Anchor geografis yang DIBOLEHKAN: Bintaro, Pesanggrahan, RC Veteran, Pintu Tol Veteran, Jakarta Selatan.',
    '- DILARANG menyebut atau mengimplikasikan BBC berlokasi di: Sudirman, Kuningan, SCBD, TB Simatupang.',
    '',
    'Pricing:',
    '- DILARANG menciptakan angka / nominal harga.',
    '- Bila pricing TIDAK ada di source/context, bahas KOMPONEN harga (faktor lokasi, fasilitas, durasi kontrak, layanan tambahan) — BUKAN nominal angka.',
    '',
    'PKP & legalitas:',
    '- DILARANG klaim PKP "pasti approved" / "guaranteed" / "100% berhasil".',
    '- Bedakan kesesuaian PKP berdasarkan KBLI:',
    '  - KBLI Jasa: virtual office BISA cocok tergantung persyaratan KPP setempat.',
    '  - KBLI Perdagangan: umumnya membutuhkan kantor fisik / service office, bukan virtual office.',
    '',
    'Layanan BBC — JANGAN klaim hal berikut kecuali source/context mengkonfirmasi secara eksplisit:',
    '- "Akses ruang meeting tanpa batas" — JANGAN tulis tanpa konfirmasi source.',
    '- BBC menawarkan coworking space — JANGAN tulis tanpa konfirmasi source.',
    '- BBC sudah melayani perusahaan multinasional — JANGAN tulis tanpa konfirmasi source.',
    '',
    '# PAGE TYPE BEHAVIOR',
    ...
    '- Target URL: <pilih HANYA dari whitelist di bawah, salin persis seperti tertulis>',
    '- Placement rationale: <kalimat singkat alasan penempatan>',
    '',
    'WHITELIST URL internal yang DIBOLEHKAN (gunakan persis seperti tertulis, jangan ubah slug):',
    '- /virtual-office',
    ...
    '- /sewa-kantor/bintaro',
    '',
    'DILARANG menyarankan URL di luar whitelist. Contoh URL yang DILARANG (tidak ada di site):',
